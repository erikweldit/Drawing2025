...
@Route("zoommenue5")
public class ZoomMenue5 extends AppLayout {   //  extends AppLayout
        ...
        // Kjør JavaScript-koden etter at komponenten er festet
                        ...
                        this.getElement().executeJs(
                                "console.log('JavaScript-koden er utført');" +
                                        ...
                                        "        activePoint.setAttribute('x', pos.x/3);" +  // Flytt teksten ved å oppdatere x- og y-koordinater
                                        "        activePoint.setAttribute('y', pos.y/3);" +
                                        "      } else {" +
                                        "        activePoint.setAttribute('cx', pos.x/3);" + // Flytt punktet ved å oppdatere cx og cy
                                        "        activePoint.setAttribute('cy', pos.y/3);" +
                                        "      }" +
                                        "      updateCurve();" +
                                        "      event.preventDefault();" +
                                        "    }" +
