...
@Route("zoomimage4")
public class ZoomImage4 extends AppLayout {   //  extends AppLayout
    double zoom;
    int x;
    int y;
    ...
    public ZoomImage4() {
        ...
        this.zoom = 4.0/3.0;
        createHeader();
   //     System.out.println("inn ZoomImage4 ");
    ...
    private void createHeader() {
        ...
        Button mytButton = new Button("Finished move");
        mytButton.addClassName("my-button");
        mytButton.addClickListener(click -> {  new MouseBue();   } );
        ...
        HorizontalLayout menuBar = new HorizontalLayout(mytButton);
    ...
    public void updateLineData(String jsonData) {
        //   System.out.println("1Oppdaterte linjepunkter: " + jsonData);
        ...
        new MouseMoved(relPoint, relPoint);
    }
