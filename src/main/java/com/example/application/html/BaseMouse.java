 ...
 */
@AnonymousAllowed
@Route(value = "Image", layout = MainLayoutDraw.class)
//@PreserveOnRefresh
 ...
 */
public class BaseMouse extends VerticalLayout {
...
/////////////////////////////////thymeleafkomponenter
        ...
        thymeleafContent.getElement().setProperty("innerHTML", getThymeleafTemplate(this.outSvg + CalcValues.svgBuffer +CalcValues.svgExtra  ));
