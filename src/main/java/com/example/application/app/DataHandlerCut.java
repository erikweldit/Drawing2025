...
public class DataHandlerCut {



    public static void processCurvePoints(String jsonData) {
        ArrayList<ExtraLine> weldCut = new ArrayList<>();
...
//////////// /
        ...
        weldCut.add(0, new ExtraLine(tellerValue[0],tellerValue[1],tellerValue[2],tellerValue[3]));
        CalcValues.weldStroke = weldCut;
