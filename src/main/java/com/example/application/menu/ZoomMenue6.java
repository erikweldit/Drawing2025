...
@AnonymousAllowed
@Route("zoommenue6")
public class ZoomMenue6 extends AppLayout {   //  extends AppLayout
    ExtraComment test;
 ...
 //       factor = 1.0;
       ...
       // String movingCurve2 =   "  <text id='draggableText' x='" + 150 + "' y='" + 150 + "' font-family='Arial' font-size='14'  style= 'pointer-events: all; cursor: pointer;' fill='" + "red" + "'>'" + '2 + "</text>";
        String movingCurve2 = "  <text id='draggableText' x='" + cx4 + "' y='" + cy4 + "' font-family='Arial' font-size='14'  style='pointer-events: all; cursor: pointer;  user-select: none;' fill='red'>" + testTall + "</text>";
 ...
 /*
   //     setContent(content);
        String movingCurve = "<svg id='svgCanvas' width='1800' height='1290' viewBox='0 0 1200 860' style='border:1px solid black;'>"
                + "<g id='zoomGroup' transform='scale(2)'>"; // Zoom er nå inni gruppen!

        String movingCurve2 = "  <text id='draggableText' x='" + (cx4 / 3) + "' y='" + (cy4 / 3) + "' font-family='Arial' font-size='14' style='pointer-events: all; cursor: pointer;' fill='red'>" + testTall + "</text>";
