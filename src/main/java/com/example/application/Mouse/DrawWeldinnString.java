...
import static com.example.application.weld.CalcValues.svgNew;
 ...
 */
@AnonymousAllowed
@Route(value = "drawing" , layout = MainLayoutDraw.class)
@PageTitle("Weld IT AS - Drawing line ")
public class DrawWeldinnString {
...
;}
     ...
     // System.out.println("out WeldingString");
    }
