...
@AnonymousAllowed
@Route(value = "movep" , layout = MainLayoutDraw.class)
public class BezierViewP extends VerticalLayout {
    ...
    public BezierViewP() {
        ...
        //  System.out.println(cx1 + " " + cy1 + " " + cx2 + " " + cy2 + " " + cx3 + " " + cy3 + " " + cx4 + " " + cy4);
        ...
        this.getElement().executeJs(
                "console.log('JavaScript-koden er utført');" +
                        ...
                        "    $0.$server.updateCurvePoints(JSON.stringify(data));" +  // Server-kall for å oppdatere punkter
                        "  }" +
                        "} else {" +
