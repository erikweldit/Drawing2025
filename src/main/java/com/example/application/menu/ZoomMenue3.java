...
@Route("zoommenue3")
public class ZoomMenue3 extends AppLayout {   //  extends AppLayout
    double zoom;
    int x;
    int y;
    ...
    public ZoomMenue3() {
       ...
       //               "    } else if (!secondClick) {" +
             //           "      secondClick = pos ;" +
                        ...
                        "  function sendLineToServer(start) {" +
                        "    const lineData = {" +
    ...
    private void createHeader() {
        ...
        Button myButton = new Button("Finished symbol");
